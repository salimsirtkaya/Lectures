...
CLoftedSurfaceContext::CLoftedSurfaceContext()
{
	...
	m_contextInfo = "Lofted Surface Menu -- You can draw lofted surfaces in this menu. Select the type of the edges from the radio buttons and mark four corner points on the display area. Do not forget to input the z-axis value for each point (default is set to 0). Note that the end condition for the clamped end spline is predefined.";
	m_menuCount = 4;
