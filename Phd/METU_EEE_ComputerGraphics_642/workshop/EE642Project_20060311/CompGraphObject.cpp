...
void CGraphPoint::RotateAround2D(CGraphPoint centerOfRotation, double angleOfRotation)
{
	...
	xTemp = RoundNum(cos(angleOfRotation) * (double) this->x - sin(angleOfRotation) * (double) this->y);
	this->y = RoundNum(sin(angleOfRotation) * (double) this->x + cos(angleOfRotation) * (double) this->y);
...
{
	this->x = RoundNum(scaleFactor * (double) this->x);
	this->y = RoundNum(scaleFactor * (double) this->y);
}

void CGraphPoint::ShearX(double shearScale)
{
	this->x = RoundNum((double) this->x + shearScale *(double) this->y);
}


void CGraphPoint::ShearY(double shearScale)
{
	this->y = RoundNum((double) this->y + shearScale * (double) this->x);
}
...
void CGraphPoint::Scale3D(double scaleFactor)
{
	this->x = RoundNum(scaleFactor * (double) this->x);
	this->y = RoundNum(scaleFactor * (double) this->y);
	this->z = RoundNum(scaleFactor * (double) this->z);
}
...
{
	this->z = RoundNum((double) this->z + shearScale * (double) this->z);
}
...
void CGraphPoint::Rotate3Dx(double angleOfRotation)
{
	...
	yTemp = RoundNum(-sin(angleOfRotation) * (double) this->z + cos(angleOfRotation) * (double) this->y);
	this->z = RoundNum(cos(angleOfRotation) * (double) this->z + sin(angleOfRotation) * (double) this->y);
	this->y = yTemp;
}
...
{
	int xTemp;
	xTemp = RoundNum(sin(angleOfRotation) * (double) this->z + cos(angleOfRotation) * (double) this->x);
	this->z = RoundNum(cos(angleOfRotation) * (double) this->z - sin(angleOfRotation) * (double) this->x);
	this->x = xTemp;
}
...
{
	int xTemp;
	xTemp = RoundNum(-sin(angleOfRotation) * (double) this->y + cos(angleOfRotation) * (double) this->x);
	this->y = RoundNum(cos(angleOfRotation) * (double) this->y + sin(angleOfRotation) * (double) this->x);
	this->x = xTemp;
}
...
void CGraphPoint::Transform3D(double Tmatrix[4][4])
{
	...
	this->z = RoundNum(Tmatrix[2][0]*x + Tmatrix[2][1]*y + Tmatrix[2][2]*z);
	this->x = RoundNum(xTemp);
	this->y = RoundNum(yTemp);
}
...
void CGraphPoint::ProjectPerspective(double xp, double yp, double zp)
{
	...
	x = RoundNum(x / divider );
	y = RoundNum(y / divider);	
}
