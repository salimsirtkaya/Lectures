...
C642Manager::~C642Manager(void)
{
	...
	delete CSpaceCurvesContext::GetInstance();
	delete CCubicSplineContext::GetInstance();
	delete CSurfaceContext::GetInstance();
}

void C642Manager::PaintRenderArea(CDC &dc)
{
	m_userContext->PaintRenderArea(dc);
}

void C642Manager::GoBackContext()
{
...
{
	m_previousContext = m_userContext;
