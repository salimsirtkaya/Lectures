...
d1=sqrt((e).^2+(f-60).^2);  %the distance from a square ahead to the goal
...
d2=sqrt((e+60).^2+(f-60).^2);   % the distance from a square at the left of the robot to the goal
...
d3=sqrt((e-60).^2+(f-60).^2);   % the distance from a square at the left of the robot to the goal
