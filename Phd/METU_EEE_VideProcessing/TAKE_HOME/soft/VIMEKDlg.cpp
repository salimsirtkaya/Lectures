...
void CVIMEKDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_nDColor, m_nDColor);
	//}}AFX_DATA_MAP
}
...
void CVIMEKDlg::Process()
{
	...
	unsigned char noDominantColor=m_nDColor;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	strFile_mpeg7 = fName+"_"+strFile+".txt" ;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	m_txtOut.InsertString(10,fName+strFile+".txt");
}
