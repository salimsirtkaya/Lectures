...
for k=1:10
    [a_lsarma_1(:,k),b_lsarma_1(:,k),sig_lsarma_1(k)]=lsarma(RY(k,:),4,4,4); 
    [a_lsarma_2(:,k),b_lsarma_2(:,k),sig_lsarma_2(k)]=lsarma(RY(k,:),4,4,8); 
    [a_lsarma_3(:,k),b_lsarma_3(:,k),sig_lsarma_3(k)]=lsarma(RY(k,:),4,4,12); 
    [a_lsarma_4(:,k),b_lsarma_4(:,k),sig_lsarma_4(k)]=lsarma(RY(k,:),4,4,16); 
...
TITLE('Exercise 3-16 PART D -->LS(ARMA) Estimate of order=4,4 for K=4');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->LS(ARMA) Estimate of order=8,8 for K=8');
XLABEL('x pi');
YLABEL('LS(ARMA) Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->LS(ARMA) Estimate of order=4,4 for K=12');
XLABEL('x pi');
YLABEL('LS(ARMA) Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->LS(ARMA) Estimate of order=8,8 for K=16');
XLABEL('x pi');
YLABEL('LS(ARMA) Estimate');
hold;
