...
for k=1:50
    ...
    phi2=unifrnd(0,2*pi);
    for (n=1:L)
      y(k,n)=10*sin(0.24*pi*n+phi1)+5*sin(0.26*pi*n+phi2);
    end
end

for k=1:50
    [a_yw_4(:,k),sig_yw_4(k)]=yulewalker(y(k,:),4);
    [a_yw_12(:,k),sig_yw_12(k)]=yulewalker(y(k,:),12);
    [a_lsar_4(:,k),sig_lsar_4(k)]=lsar(y(k,:),4);
    [a_lsar_12(:,k),sig_lsar_12(k)]=lsar(y(k,:),12);    
    [a_myw1_4(:,k),gamma_myw1_4(:,k)]=mywarma(y(k,:),4,4,4);
    [a_myw1_12(:,k),gamma_myw1_12(:,k)]=mywarma(y(k,:),12,12,12);    
    ...
    [a_lsarma1_12(:,k),b_lsarma1_12(:,k),sig_lsarma1_12(k)]=lsarma(y(k,:),12,12,12); 
...
TITLE('Exercise 3-17 PART c -->Yule Walker Estimate of order 4');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->Yule Walker Estimate of order 12');
XLABEL('x pi');
YLABEL('Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->LS(AR) Estimate of order 4');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->LS(AR) Estimate of order 12');
XLABEL('x pi');
YLABEL('LS(AR) Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->Modified Yule Walker Estimate for order=4,4 and M=n');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->Modified Yule Walker Estimate for order=12,12 and M=n');
XLABEL('x pi');
YLABEL('Modified Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->Modified Yule Walker Estimate for order=4,4 and M=2n');
XLABEL('x pi');
YLABEL('Modified Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->Modified Yule Walker Estimate for order=12,12 and M=2n');
XLABEL('x pi');
YLABEL('Modified Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->LS(ARMA) Estimate of order=4,4 for K=n');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->LS(ARMA) Estimate of order=4,4 for K=2n');
XLABEL('x pi');
YLABEL('LS(ARMA) Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->LS(ARMA) Estimate of order=12,12 for K=n');
XLABEL('x pi');
YLABEL('LS(ARMA) Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2),'r','LineWidth',2.5);
TITLE('Exercise 3-17 PART c -->LS(ARMA) Estimate of order=12,12 for K=2n');
XLABEL('x pi');
YLABEL('LS(ARMA) Estimate');
hold;
...
TITLE('Exercise 3-17 PART c -->Pole-Zero Plot for the YW method n=4');
...
TITLE('Exercise 3-17 PART c -->Pole-Zero Plot for the YW method n=12');
...
TITLE('Exercise 3-17 PART c -->Pole-Zero Plot for the LSAR method n=4');
...
TITLE('Exercise 3-17 PART c -->Pole-Zero Plot for the LSAR method n=12');
...
TITLE('Exercise 3-17 PART c -->LSARMA method n=4, m=4, K=n');
...
TITLE('Exercise 3-17 PART c -->LSARMA method n=4, m=4, K=2n');
...
TITLE('Exercise 3-17 PART c -->LSARMA method n=12, m=12, K=n');
...
TITLE('Exercise 3-17 PART c -->LSARMA method n=12, m=12, K=2n');
...
TITLE('Exercise 3-17 PART c -->MYWARMA method n=4, m=4, M=n');
...
TITLE('Exercise 3-17 PART c -->MYWARMA method n=4, m=4, M=2n');
...
TITLE('Exercise 3-17 PART c -->MYWARMA method n=12, m=12, M=n');
...
TITLE('Exercise 3-17 PART c -->MYWARMA method n=12, m=12, M=2n');