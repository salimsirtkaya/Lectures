...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'b','LineWidth',2.5);
...
for k=1:10
    ...
    [a_myw1_4(:,k),gamma_myw1_4(:,k)]=mywarma(RY(k,:),4,4,4);
    [a_myw1_8(:,k),gamma_myw1_8(:,k)]=mywarma(RY(k,:),8,8,8);    
    [a_myw2_4(:,k),gamma_myw2_4(:,k)]=mywarma(RY(k,:),4,4,8);  
    [a_myw2_8(:,k),gamma_myw2_8(:,k)]=mywarma(RY(k,:),8,8,16);
    [a_lsarma_4(:,k),b_lsarma_4(:,k),sig_lsarma_4(k)]=lsarma(RY(k,:),4,4,8); 
    [a_lsarma_8(:,k),b_lsarma_8(:,k),sig_lsarma_8(k)]=lsarma(RY(k,:),8,8,16); 
end
...
TITLE('Exercise 3-16 PART A -->Yule Walker Estimate of order 4');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->Yule Walker Estimate of order 8');
XLABEL('x pi');
YLABEL('Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->Modified Yule Walker Estimate for order=4,4 and M=n');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->Modified Yule Walker Estimate for order=8,8 and M=n');
XLABEL('x pi');
YLABEL('Modified Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->Modified Yule Walker Estimate for order=4,4 and M=2n');
XLABEL('x pi');
YLABEL('Modified Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->Modified Yule Walker Estimate for order=8,8 and M=2n');
XLABEL('x pi');
YLABEL('Modified Yule Walker Estimate');
hold;
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->LS(ARMA) Estimate of order=4,4');
XLABEL('x pi');
...
figure;
plot(freq1(1:L/2),H(1:L/2)/H(1),'r','LineWidth',2.5);
TITLE('Exercise 3-16 PART A -->LS(ARMA) Estimate of order=8,8');
XLABEL('x pi');
YLABEL('LS(ARMA) Estimate');
hold;
...
figure;
zplane(b,a);
TITLE('Exercise 3-16 PART A -->Pole-Zero Plot for the original filter');

figure;
zplane(1,a_yw_4(1:5,5)');
TITLE('Exercise 3-16 PART A -->Pole-Zero Plot for the YW method n=4');

figure;
zplane(1,a_yw_8(1:5,5)');
TITLE('Exercise 3-16 PART A -->Pole-Zero Plot for the YW method n=8');

figure;
zplane(1,a_lsar_4(1:5,5)');
TITLE('Exercise 3-16 PART A -->Pole-Zero Plot for the LS(AR) method n=4');

figure;
zplane(1,a_lsar_8(1:5,5)');
TITLE('Exercise 3-16 PART A -->Pole-Zero Plot for the LS(AR) method n=8');

figure;
zplane(b_lsarma_4(1:5,5)',a_lsarma_4(1:5,5)');
TITLE('Exercise 3-16 PART A -->Pole-Zero Plot for the LS(ARMA) method n=4 m=4');

figure;
zplane(b_lsarma_8(1:5,5)',a_lsarma_8(1:5,5)');
TITLE('Exercise 3-16 PART A -->Pole-Zero Plot for the LS(ARMA) method n=8 m=8');
