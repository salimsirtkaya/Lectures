function [x,Kd,fitt]=Genetic_Algorithm(pop_count,max_generation,x0)
global n;
n=24;
global x0;
population=randint(pop_count,n); %Creates initial population
Fit_array=Population_Fitness(population,pop_count);%%%%%%%%%%%%
for generation=1:max_generation
    [population,Fit_array]=NewPopulation(population,Fit_array,pop_count);
end
